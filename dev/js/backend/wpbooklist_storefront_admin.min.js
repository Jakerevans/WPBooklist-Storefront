...
jQuery( document ).ready( function( $ ) {
	...
	wpbooklistStorefrontPluginPageDashboardSaveKey();
	...
	// Function that will handle the saving of the user's License Key.
	function wpbooklistStorefrontPluginPageDashboardSaveKey() {

		// When the 'Save' button is clicked at the top of the dashboard...
		$( '#wpbooklist-extension-genreric-key-dashboard-form-storefront' ).on( 'submit', function() {

			var license = $( '#wpbooklist-extension-genreric-key-dashboard-input-storefront' ).val();

			// Make Ajax call to get display options.
			var data = {
				'action': 'wpbooklist_storefront_save_license_key_action',
				'security': wpbooklistStoreFrontPhpVariables.adminnonce3,
				'license': license
			};
		...
		$( '#wpbooklist-extension-genreric-key-plugins-page-button-storefront' ).on( 'click', function() {
	...
	function wpbooklistResetStorefrontSettingsImages(){
		...
		$("#wpbooklist-storefront-img-remove-1").click(function(event){
  			$('#wpbooklist-storefront-preview-img-1').attr('src', wpbooklistStoreFrontPhpVariables.ROOT_WPBL_IMG_ICONS_URL + 'book-placeholder.svg');
  		});

  		$("#wpbooklist-storefront-img-remove-2").click(function(event){
  			$('#wpbooklist-storefront-preview-img-2').attr('src', wpbooklistStoreFrontPhpVariables.ROOT_WPBL_IMG_ICONS_URL + 'book-placeholder.svg');
  		});
	...
	function wpbooklistRevealStorefrontFieldsOnYes() {
		...
		$(document).on( 'change', '#wpbooklist-addbook-storefront-select-woocommerce', function(event){
			...
			// Enable the Select2 on the Upsells and Crosssells Fields.
			...
			if ( wpbooklistStoreFrontPhpVariables.storefronttrans24 === $(this).val() ) {
				...
				div = $( '#wpbooklist-book-form-storefront-initial-hidden-fields' );

				// Set the 'Regular Price' to whatever the 'Sale Price' is
				$( '#wpbooklist-addbook-woo-regular-woo-price' ).val( $( '#wpbooklist-addbook-price' ).val() ); 
	...
	function wpbooklistStoreFrontAdminPointersJavascript() {
		...
		$( 'body' ).on( 'mouseenter', '.wpbooklist-icon-image-question', function() {
			...
			case 'book-form-isbn10':
				pointer = $( this ).pointer({
					content: '<h3>' + wpbooklistStoreFrontPhpVariables.trans135 + '</h3><p class="wpbooklist-admin-pointer">' + wpbooklistStoreFrontPhpVariables.trans173 + '.</p>',
					position: {
						edge: 'right',
						align: 'right'
					}
		...
		$( 'body' ).on( 'mouseenter', '.wpbooklist-icon-image-question-with-link', function() {
			...
			case 'book-form-libraries':
				pointer = $( this ).pointer({
					content: '<h3>' + wpbooklistStoreFrontPhpVariables.trans203 + '</h3><p class="wpbooklist-admin-pointer">' + wpbooklistStoreFrontPhpVariables.trans204 + wpbooklistStoreFrontPhpVariables.SETTINGS_PAGE_URL + wpbooklistStoreFrontPhpVariables.trans205 + '.</p>',
					position: {
						edge: 'right',
						align: 'right'
					}
