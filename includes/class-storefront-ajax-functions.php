...
function wpbooklist_storefront_settings_action_javascript() { 
	?>
  	...
  	jQuery(document).ready(function($) {
  		...
  		$("#wpbooklist-storefront-img-remove-1").click(function(event){
  			$('#wpbooklist-storefront-preview-img-1').attr('src', '<?php echo ROOT_IMG_ICONS_URL ?>'+'book-placeholder.svg');
  		});

  		$("#wpbooklist-storefront-img-remove-2").click(function(event){
  			$('#wpbooklist-storefront-preview-img-2').attr('src', '<?php echo ROOT_IMG_ICONS_URL ?>'+'book-placeholder.svg');
  		});
	  	...
	  	$("#wpbooklist-storefront-save-settings").click(function(event){
		  	...
		  	var data = {
				...
				'security': '<?php echo wp_create_nonce( "wpbooklist_storefront_settings_action_callback" ); ?>',
...
function wpbooklist_storefront_settings_action_callback(){
	global $wpdb;
	...
	$table_name = STOREFRONT_PREFIX.'wpbooklist_jre_storefront_options';
...
function wpbooklist_storefront_save_default_action_javascript() { 

	$trans1 = __("Success!", 'wpbooklist');
	$trans2 = __("You've saved your default StoreFront WooCommerce Settings!", 'wpbooklist');
	...
	?>
  	...
  	"use strict";
  	jQuery(document).ready(function($) {
	  	$("#wpbooklist-storefront-woo-settings-button").click(function(event){

	  		$('#wpbooklist-storefront-woo-set-success-div').html('');
			...
			if(salebegin != undefined && saleend != undefined){
		  	...
		  	var data = {
				'action': 'wpbooklist_storefront_save_action_default',
				'security': '<?php echo wp_create_nonce( "wpbooklist_storefront_save_default_action_callback" ); ?>',
				'saleprice':salePrice,
...
function wpbooklist_storefront_save_default_action_callback(){
	global $wpdb;
	check_ajax_referer( 'wpbooklist_storefront_save_default_action_callback', 'security' );
...
function wpbooklist_storefront_upcross_pop_action_javascript() { 
	?>
  	<script type="text/javascript" >
  	"use strict";
  	jQuery(document).ready(function($) {
		  	...
		  	var data = {
				'action': 'wpbooklist_storefront_upcross_pop_action',
				'security': '<?php echo wp_create_nonce( "wpbooklist_storefront_upcross_pop_action_callback" ); ?>',
			};
...
// Callback function for creating backups
function wpbooklist_storefront_upcross_pop_action_callback(){
	global $wpdb;
	check_ajax_referer( 'wpbooklist_storefront_upcross_pop_action_callback', 'security' );
...
add_action( 'admin_footer', 'wpbooklist_storefront_action_javascript' );
add_action( 'wp_ajax_wpbooklist_storefront_action', 'wpbooklist_storefront_action_callback' );
add_action( 'wp_ajax_nopriv_wpbooklist_storefront_action', 'wpbooklist_storefront_action_callback' );


function wpbooklist_storefront_action_javascript() { 
	?>
  	<script type="text/javascript" >
  	"use strict";
  	jQuery(document).ready(function($) {
	  	$("#wpbooklist-admin-addbook-button").click(function(event){
		  	...
		  	var data = {
				'action': 'wpbooklist_storefront_action',
				'security': '<?php echo wp_create_nonce( "wpbooklist_storefront_action_callback" ); ?>',
			};
			console.log(data);
...
// Callback function for creating backups
function wpbooklist_storefront_action_callback(){
	global $wpdb;
	check_ajax_referer( 'wpbooklist_storefront_action_callback', 'security' );
