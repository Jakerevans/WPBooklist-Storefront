<?php
/**
 * WPBookList WPBookList_Storefront_Update_Actual Class
 *
 * @author   Jake Evans
 * @category admin
...
if ( ! class_exists( 'WPBookList_Storefront_Update_Actual', false ) ) :
	/**
	 * WPBookList_Storefront_Update_Actual Class.
	 */
	class WPBookList_Storefront_Update_Actual {
		...
		public function __construct( $_api_url, $_plugin_file, $_api_data = null ) {
			...
			if ( false === stripos( $this->extension_settings->treh, 'aod' ) ) {
				error_log('no dice!');
				return false;
			}
